                        ...
                        <tbody>
                            ...
                            <tr id="<?php echo e($scoreud->id); ?>" style="display:none">
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                        <form method="post" action="/tabulate/gmdc/save/<?php echo e($scoreud ->id); ?>"><?php echo csrf_field(); ?>
                                    ...
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="mej1" value="<?php echo e($scoreud->mej1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="mej2" value="<?php echo e($scoreud->mej2); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="mej3" value="<?php echo e($scoreud->mej3); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="evj1" value="<?php echo e($scoreud->evj1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="evj2" value="<?php echo e($scoreud->evj2); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="evj3" value="<?php echo e($scoreud->evj3); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="aij1" value="<?php echo e($scoreud->aij1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="aij2" value="<?php echo e($scoreud->aij2); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="aij3" value="<?php echo e($scoreud->aij3); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <?php elseif(Auth::user()->role === 'judge1'): ?>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="crj1" value="<?php echo e($scoreud->crj1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="mej1" value="<?php echo e($scoreud->mej1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                                    <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><input size="10" type="text" name="evj1" value="<?php echo e($scoreud->evj1); ?>" style="color: black; padding-right: 3px; padding-left: 3px; text-align: center;"></input></td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr id="trmhead2<?php echo e($score->id); ?>">
                                ...
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->mej1); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->mej2); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->mej3); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->evj1); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->evj2); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->evj3); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->aij1); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->aij2); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->aij3); ?></td>
                                <?php elseif(Auth::user()->role === 'judge1'): ?>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->crj1); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->mej1); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e($score->evj1); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\Users\IMSD-CASHIER\Desktop\Tabulation\TABULATE\resources\views/gmdc-tab.blade.php ENDPATH**/ ?>