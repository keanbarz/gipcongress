            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100" style="color: green;">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $mgescores->zip($ranks); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$mgescore, $rank]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?php echo e($mgescore->office); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e(number_format ($mgescore->acarj,2)); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e(number_format ($mgescore->acrj,2)); ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: center;"><?php echo e(number_format ($mgescore->total , 2)); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\Users\IMSD-CASHIER\Desktop\Tabulation\TABULATE\resources\views/mge.blade.php ENDPATH**/ ?>