...
<?php endif; ?>
    ...
    <tr>        
            <th style="border: 0px solid #ddd; padding: 10px; "></th>
            <th style="border: 0px solid #ddd; padding: 10px;"><?php echo e($name->NAME); ?></th>
            <th style="border: 0px solid #ddd; padding: 10px; "></th>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <th style="padding: 10px; min-width: unset;">Date</th>
            <th style="padding: 10px; min-width: unset;">Time</th>
    ...
    <tbody>
        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $records): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?php echo e($records->sDate); ?></td>     
                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?php echo e($records->stime); ?></td>      
...
<?php endif; ?>
<?php /**PATH C:\Users\IMSD-CASHIER\Desktop\Tabulation\TABULATE\resources\views/dtr.blade.php ENDPATH**/ ?>